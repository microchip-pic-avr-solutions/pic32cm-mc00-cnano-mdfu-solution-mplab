...
set IS_DEBUG=%2
set OUTPUT_IMAGE_PATH="PIC32CM_TestApp_I2C.img"
REM - Relative path to client config file
set CONFIG_FILE_PATH="..\..\Bootloader_I2C\src\config\default\bootloader\configurations\bootloader_configuration.toml"
