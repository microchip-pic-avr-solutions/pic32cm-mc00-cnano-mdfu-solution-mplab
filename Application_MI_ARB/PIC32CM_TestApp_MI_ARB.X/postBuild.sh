...
INPUT_IMAGE_PATH=$1
IS_DEBUG=$2
OUTPUT_IMAGE_PATH="PIC32CM_TestApp_Binary_v1.img"
# - Relative path to client config file
CONFIG_FILE_PATH="../../Bootloader_MI_ARB/src/config/default/bootloader/configurations/bootloader_configuration.toml"
